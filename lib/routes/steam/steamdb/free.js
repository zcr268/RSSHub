...
module.exports = async(ctx) => {
    ...
    // const html = await cloudscraper.get(url);F
    ...
    const getItems = $trs
        ...
        .map((el) => {
            ...
            const description = ctx.cache.tryGet(hoverLink, async () => {
                // const description = await cloudscraper.get(hoverLink);
                // const description = cloudscraper.get(hoverLink);
                ...
                logger.info(`Request ${hoverLink} description=${description}`);
